	<nav class="ts-sidebar">
			...
			<li><a href="feedback.php"><i class="fa fa-comment"></i> &nbsp;Feedback</a>
			</li>
			...
			<li><a href="display.html"><i class="fa fa-image"></i> &nbsp;Upload Image</a>

                        </ul>
			<p class="text-center" style="color:#ffffff; margin-top: 100px;">© Karamveer</p>
		</nav>
